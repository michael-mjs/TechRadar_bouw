...
const Sidebar = ({ selected, rings, quadrants, allBlips, onClose, onNavigate }) => {
  ...
  return (
    <div className="w-96 bg-slate-800/60 border-l border-slate-700/50 backdrop-blur-sm p-6 flex flex-col overflow-y-auto shrink-0">
      ...
      {/* Image Embed */}
      <div className="mb-5 w-full rounded-xl overflow-hidden shadow-lg border border-slate-700/50 bg-slate-900/50 relative flex justify-center items-center aspect-square min-h-[120px]">
        {selected.linkImage ? (
          <img 
